...
b1 = tf.Variable(tf.truncated_normal([layer_dim[0]], stddev=0.1))
w2 = tf.Variable(tf.truncated_normal([layer_dim[0], layer_dim[1]], stddev=0.1))
b2 = tf.Variable(tf.truncated_normal([layer_dim[1]], stddev=0.1))
w3 = tf.Variable(tf.truncated_normal([layer_dim[1], layer_dim[2]], stddev=0.1))
b3 = tf.Variable(tf.truncated_normal([layer_dim[2]], stddev=0.1))
w4 = tf.Variable(tf.truncated_normal([layer_dim[2], layer_dim[3]], stddev=0.1))
b4 = tf.Variable(tf.truncated_normal([layer_dim[3]], stddev=0.1))
w5 = tf.Variable(tf.truncated_normal([layer_dim[3], layer_dim[4]], stddev=0.1))
b5 = tf.Variable(tf.truncated_normal([layer_dim[4]], stddev=0.1))
