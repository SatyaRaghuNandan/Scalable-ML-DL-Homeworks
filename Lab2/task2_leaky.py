...
b1 = tf.Variable(tf.truncated_normal([layer_dim[0]], stddev=0.3))
w2 = tf.Variable(tf.truncated_normal([layer_dim[0], layer_dim[1]], stddev=0.1))
b2 = tf.Variable(tf.truncated_normal([layer_dim[1]], stddev=0.3))
w3 = tf.Variable(tf.truncated_normal([layer_dim[1], layer_dim[2]], stddev=0.1))
b3 = tf.Variable(tf.truncated_normal([layer_dim[2]], stddev=0.3))
w4 = tf.Variable(tf.truncated_normal([layer_dim[2], layer_dim[3]], stddev=0.1))
b4 = tf.Variable(tf.truncated_normal([layer_dim[3]], stddev=0.3))
...
y1 = lrelu(y1_logits, 0.02)
y2_logits = tf.matmul(y1, w2) + b2
y2 = lrelu(y2_logits, 0.02)
y3_logits = tf.matmul(y2, w3) + b3
y3 = lrelu(y3_logits, 0.02)
y4_logits = tf.matmul(y3, w4) + b4
y4 = lrelu(y4_logits, 0.02)
